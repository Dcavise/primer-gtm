...
const SimpleDatabaseTest = () => {
  ...
  const checkFunctionExists = async () => {
    try {
      ...
      setDiagResults("Please create the test_schema_exists function in the Supabase SQL Editor using the SQL below:\n\n" +
                    ...
                    {publicTables.length > 0 ? (
                      <div className="mt-2">
                        ...
                        <ul className="text-sm list-disc pl-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-1">
                          ...
                          {publicTables.length > 10 && <li>...and {publicTables.length - 10} more</li>}
                        </ul>
                      </div>
                    ) : (
                    ...
                    {salesforceTables.length > 0 ? (
                      <div className="mt-2">
                        ...
                        <ul className="text-sm list-disc pl-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-1">
                          ...
                          {salesforceTables.length > 10 && <li>...and {salesforceTables.length - 10} more</li>}
                        </ul>
                      </div>
                    ) : (
                      <p className="text-yellow-600 mt-2">No tables found</p>
