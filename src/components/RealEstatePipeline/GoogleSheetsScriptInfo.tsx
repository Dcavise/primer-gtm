...
export const GoogleSheetsScriptInfo = () => {
  ...
  // This is the Google Apps Script code that will be provided to the user
...
`;
  ...
  // Instructions for setting up the Apps Script
...
7. You'll see a new menu item "Supabase Sync" with a "Sync to Database" option
8. Click it to run the sync
  `;
