...
export const mockProperties = [
  {
    ...
    longitude: -122.4194,
    description:
      "Gorgeous modern home in the heart of San Francisco with stunning views and high-end finishes.",
    progress: 85,
  ...
  },
  {
    ...
    longitude: -122.2711,
    description:
      "Modern townhouse in a quiet neighborhood with easy access to transportation and amenities.",
    progress: 65,
    stage: "Due Diligence",
  ...
  },
  {
    ...
    longitude: -122.273,
    description:
      "Well-maintained multi-family property near UC Berkeley. Great investment opportunity.",
    progress: 25,
    ...
    notes:
      "Owner is considering selling but hasn't committed yet. Building has strong rental history.",
    lease: {
      startDate: "",
      endDate: "",
      term: "",
...
export const mockFiles = [
  {
    ...
    description:
      "Complete property assessment including structural evaluation and estimated renovation costs.",
    url: "#",
    resourceId: "mock-property-1",
    resourceType: "property",
  },
  ...
  },
  {
    ...
    description:
      "Environmental assessment report including soil testing and hazardous materials survey.",
    url: "#",
    resourceId: "mock-property-1",
    resourceType: "property",
  },
...
export const mockRealEstatePipeline = [
  ...
  },
  {
    ...
    phase: "Deprioritize",
    campus_id: "campus-1",
    site_name: "Maple Street Building",
  },
];
