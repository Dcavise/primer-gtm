    ...
    >
      <CardHeader className="p-3 pb-0">
        <div className="flex justify-between items-start">
          <h3 className="font-medium text-base">{property.site_name || "Unnamed Property"}</h3>
          <div
            className={`px-2 py-1 rounded-md text-xs font-medium ${getPhaseColorClass(property.phase)}`}
          >
