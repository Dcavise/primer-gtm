  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        const viewName = 
          period === 'day' ? 'closed_won_daily' : 
          period === 'week' ? 'closed_won_weekly' : 'closed_won_monthly';
...
function processFormattedMetrics(rawData: FormattedOpportunityMetric[], period: string): FormattedLeadsResponse {
