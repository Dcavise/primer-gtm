    ...
    try {
      ...
      if (isDeveloperMode) {
        ...
        const mockData: CensusData = {
          ...
          categories: {
            demographic: [
              { name: 'Under 18', value: `${mockCensusData.demographics.ageDistribution.under18}%` },
              { name: '18-24', value: `${mockCensusData.demographics.ageDistribution.age18to24}%` },
              { name: '25-44', value: `${mockCensusData.demographics.ageDistribution.age25to44}%` },
              { name: '45-64', value: `${mockCensusData.demographics.ageDistribution.age45to64}%` },
              { name: '65+', value: `${mockCensusData.demographics.ageDistribution.age65plus}%` },
            ],
            economic: [
              { name: 'Median Household Income', value: `$${mockCensusData.economics.medianHouseholdIncome.toLocaleString()}` },
              { name: 'Poverty Rate', value: `${mockCensusData.economics.povertyRate}%` },
              { name: 'Unemployment Rate', value: `${mockCensusData.economics.unemploymentRate}%` },
            ],
            housing: [
              { name: 'Total Housing Units', value: mockCensusData.housing.totalHousingUnits.toLocaleString() },
              { name: 'Occupancy Rate', value: `${mockCensusData.housing.occupancyRate}%` },
              { name: 'Owner Occupied', value: `${mockCensusData.housing.ownerOccupied}%` },
              { name: 'Renter Occupied', value: `${mockCensusData.housing.renterOccupied}%` },
              { name: 'Median Home Value', value: `$${mockCensusData.housing.medianHomeValue.toLocaleString()}` },
              { name: 'Median Rent', value: `$${mockCensusData.housing.medianRent}` },
            ],
            education: [
              { name: 'High School or Less', value: `${mockCensusData.economics.educationLevels.highSchoolOrLess}%` },
              { name: 'Some College', value: `${mockCensusData.economics.educationLevels.someCollege}%` },
              { name: 'Bachelor\'s Degree', value: `${mockCensusData.economics.educationLevels.bachelors}%` },
              { name: 'Graduate Degree', value: `${mockCensusData.economics.educationLevels.graduate}%` },
            ],
          }
        };
