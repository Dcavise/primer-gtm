...
describe("useStats integration", () => {
  beforeEach(() => {
    ...
    mockSupabase.or.mockImplementationOnce(() => {
      return {
        ...mockSupabase,
        then: (callback: any) => mockFellowsPromise.then(callback),
      };
    });
    ...
    mockSupabase.eq.mockImplementationOnce(() => {
      return {
        ...mockSupabase,
        then: (callback: any) => mockLeadsPromise.then(callback),
      };
    });
    ...
    mockSupabase.rpc.mockImplementationOnce(() => {
      return {
        ...mockSupabase,
        then: (callback: any) => mockWeeklyPromise.then(callback),
      };
    });
    ...
    mockSupabase.eq.mockImplementationOnce(() => {
      return {
        ...mockSupabase,
        then: (callback: any) => mockActiveOppsPromise.then(callback),
      };
    });
    ...
    mockSupabase.eq.mockImplementationOnce(() => {
      return {
        ...mockSupabase,
        then: (callback: any) => mockStagesPromise.then(callback),
      };
    });
    ...
    mockSupabase.eq.mockImplementationOnce(() => {
      return {
        ...mockSupabase,
        then: (callback: any) => mockClosedWonPromise.then(callback),
      };
    });
  });
